...
tabPanel("N-grams Over Time",
         sidebarLayout(
           sidebarPanel(
             selectInput("corpus", "Sub-Corpus", 
                         choices = c("indentured", 
                                     "Ireland",
                                     "Spanish",
                                     "Werowocomoco",
                                     "West Indies",
                                     ...
                                     "Portugal",
                                     "Bellarmine")),
             actionButton("run6", "View N-grams Over Time"),
...
# Display word embeddings based on selections
  ...
  # Display N-gramss based on selections
  observeEvent(input$run6, {
    output$ngram = renderUI({
      addResourcePath("www", "www")
      img(src = paste0(input$corpus, ".png"),
          height="70%",
          width="80%")
    })
